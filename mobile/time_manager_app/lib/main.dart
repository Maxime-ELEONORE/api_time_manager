...
import 'package:time_manager_app/pages/login.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Time Manager'),
    );
  }
}
...
class MyHomePageState extends State<MyHomePage> {
  // bool connected = SessionService().isLogedIn();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Center(
        ...
        child: connected ? const MainComponentView() : const LoginView(),
      ),
    );
  }
}
